...
const TopNav: FunctionComponent<Props> = ({ intersecting }) => {
  ...
  return (
    <div
      className={`${
        intersecting ? 'c-nav' : 'bg-white'
      }  fixed w-full z-10 border-b border-black py-4`}
    >
      <div className="c-nav-wrapper mx-auto flex items-center justify-between">
        ...
        <div className="flex justify-around items-center">
          <Link href="/">
            <a className="pr-7 font-normal text-sm hover:text-gray-800">
              Our Story
            </a>
          </Link>
          <Link href="/">
          ...
          <Button
            type="link"
            className="pl-0 pr-7 font-normal text-sm text-black hover:text-gray-800"
          ...
          <Button
            ...
            shape="round"
            className={`${
              !intersecting ? 'bg-green-700' : 'bg-black'
            } text-white border-none font-normal text-xs hover:bg-black hover:text-white`}
